...
uint256 hashGenesisBlock("0x704c2d10847c99d8b7ebf1b01472a83ae830c2bc4cf627226afdd7175c94d27c");
...
const string strMessageMagic = "StadiCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // StadiCoin: 1 days
static const int64 nTargetSpacing = 30; // StadiCoin: 30 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal stadicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StadiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1c5a99cb0a0a46cbcd86346ae9200998ad36338db23f178716424affd4057fb2");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Oscarit jaettiin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393829928; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 653906;

        if (fTestNet)
        {
            block.nTime    = 1393829927;
            block.nNonce   = 212215;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xca39686cd2003ef19b5de49120e3513af3b9ec48a83837b6c78b90631b9eb306"));
